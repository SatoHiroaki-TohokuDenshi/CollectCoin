...
FbxParts::FbxParts()
	...
	pVertexData_(nullptr), ppIndexData_(nullptr), pMaterial_(nullptr), pSkinInfo_(nullptr),
	pBoneArray_(nullptr), pWeightArray_(nullptr), ppCluster_(nullptr),
	indexCount_(0), materialCount_(0), numBone_(0), vertexCount_(0), polygonCount_(0), polygonVertexCount_(0)
{
}
